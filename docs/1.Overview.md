...
erDiagram
    ...
    API_Gateway {
        ...
        gRPC Backend Interface "Service communication"
    }

    AI_Inference {
        LLM Inference Service "Chat completion"
        Text Embeddings Service "Vector generation"
        Audio Processing Service "Transcription"
    }

    Data_Persistence {
        Turso SQLite Adapter "Application data"
        Supabase PostgreSQL "Vector storage"
    }

    UI {
        Leptos SSR Application "Web interface"
    }

    Infrastructure {
        Kubernetes Deployment Manager "Container orchestration"
