...
> [!IMPORTANT]
> The following steps assume that you already have a deployed and accessible UDS Kubernetes cluster and CowabungaAI. Please follow the steps within the [DEVELOPMENT.md](../../docs/DEVELOPMENT_legacy.md) for details.
...
See the ["Access" section of the DEVELOPMENT.md](../../docs/DEVELOPMENT_legacy.md#access) for different ways to connect the API to a model backend or Supabase.
