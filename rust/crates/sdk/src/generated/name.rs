...
pub mod name_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn name(
            ...
            let path = http::uri::PathAndQuery::from_static("/name.NameService/Name");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("name.NameService", "Name"));
...
pub mod name_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/name.NameService/Name" => {
                    ...
                    struct NameSvc<T: NameService>(pub Arc<T>);
                    impl<T: NameService> tonic::server::UnaryService<()> for NameSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            ...
                            let fut = async move {
                                <T as NameService>::name(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "name.NameService";
