...
class COWABUNGA_Model(DeepEvalBaseLLM):
    """
    A DeepEval LLM class that utilizes the CowabungaAI API to prompt certain benchmarks
    ...
    def __init__(
        ...
        self.base_url = base_url or os.getenv("COWABUNGA_API_URL") + "/openai/v1"
    ...
    def generate(
        ...
        """Generates a response from CowabungaAI API using the OpenAI SDK"""
    ...
    def get_model_name(self):
        return f"CowabungaAI {self.model}"
