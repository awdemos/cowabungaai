...
class NIAH_Runner:
    """
    A runner to handle executing Needle in a Haystack (NIAH) evals for CowabungaAI

    This runner assumes CowabungaAI is already deployed
    ...
    def __init__(
        self,
        dataset: str = "defenseunicorns/COWABUNGA_RAG_niah_v1",
        ...
        self.client = openai.OpenAI(
            base_url=base_url or os.environ.get("COWABUNGA_API_URL") + "/openai/v1",
            api_key=api_key or os.environ.get("COWABUNGA_API_KEY"),
        )
