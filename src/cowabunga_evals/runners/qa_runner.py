...
class QA_Runner:
    """
    A runner to handle executing Question and Answer (QA) evals for CowabungaAI
    ...
    def __init__(
        self,
        dataset: str = "defenseunicorns/COWABUNGA_RAG_qa_v1",
        model: str = "vllm",
        ...
        self.client = openai.OpenAI(
            base_url=base_url or os.getenv("COWABUNGA_API_URL") + "/openai/v1",
