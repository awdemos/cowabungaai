...
Repository root: /Users/a/code/ai/cowabungaai
Blind packet: /Users/a/code/ai/cowabungaai/.desloppify/review_packet_blind.json
Batch index: 17
...
Overview (47 signals):
  design_concern: 36 — packages/llama-cpp-python/scripts/model_download.py, packages/text-embeddings/main.py, ...
  mixed_responsibilities: 8 — packages/llama-cpp-python/main.py, packages/repeater/main.py, ...
  duplication_design: 2 — src/cowabunga_api/data/crud_run.py, src/cowabunga_evals/metrics/annotation_relevancy.py
  interface_design: 1 — .github/scripts/uds_verification_report.py
...
For each concern, read the source code and report your verdict in issues[]:
  ...
  - [design_concern] packages/text-embeddings/main.py
    ...
    fingerprint: 1c7663f4ab93abff
  - [design_concern] packages/turso/api.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (39 LOC): zero importers, not an entry point
    fingerprint: 87c8db3a773ab0ce
  - [design_concern] packages/vllm/src/main.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (265 LOC): zero importers, not an entry point
    fingerprint: 6c85e2cc207c91f3
  - [design_concern] packages/whisper/main.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (132 LOC): zero importers, not an entry point
    fingerprint: 59bc399f8050b216
  - [design_concern] src/cowabunga_api/backend/composer.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (403 LOC): zero importers, not an entry point
    fingerprint: c58d753cd6eb0ea0
  - [design_concern] src/cowabunga_api/backend/converters.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (132 LOC): zero importers, not an entry point
    fingerprint: 143c4222eb5f1880
  - [design_concern] src/cowabunga_api/backend/grpc_client.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (191 LOC): zero importers, not an entry point
    fingerprint: edb2cc1c474f4b1c
  - [design_concern] src/cowabunga_api/backend/helpers.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (126 LOC): zero importers, not an entry point
    fingerprint: 086379409cd78445
  - [design_concern] src/cowabunga_api/backend/rag/document_loader.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (101 LOC): zero importers, not an entry point
    fingerprint: 11dce858e21c3bdb
  - [design_concern] src/cowabunga_api/data/crud_api_key.py
    ...
    fingerprint: 6bd3a1d96a0d1881
  - [design_concern] src/cowabunga_api/data/database/turso_client.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (303 LOC): zero importers, not an entry point
    fingerprint: d5364d72fdeb9e7c
  - [design_concern] src/cowabunga_api/main.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (125 LOC): zero importers, not an entry point
    fingerprint: 242020fd6d6d7dcc
  - [design_concern] src/cowabunga_api/routers/cowabunga/auth.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (123 LOC): zero importers, not an entry point
    fingerprint: d9280ea3dc1bcaf0
  - [design_concern] src/cowabunga_api/routers/cowabunga/tokens.py
    summary: Design signals from orphaned
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned
    evidence: [orphaned] Orphaned file (24 LOC): zero importers, not an entry point
    fingerprint: 98dafe78def8f190
  - [design_concern] src/cowabunga_api/routers/health.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (78 LOC): zero importers, not an entry point
    fingerprint: 32f4f0f02f0f4bad
  - [design_concern] src/cowabunga_api/routers/openai/assistants.py
    summary: Design signals from orphaned, signature
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, signature
    evidence: [orphaned] Orphaned file (193 LOC): zero importers, not an entry point
    fingerprint: 43eeacbaeb4e2405
  - [design_concern] src/cowabunga_api/routers/openai/audio.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (75 LOC): zero importers, not an entry point
    fingerprint: 48bc78b4c7e7c5dc
  - [design_concern] src/cowabunga_api/routers/openai/chat.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (80 LOC): zero importers, not an entry point
    fingerprint: 84b83dfce1ad6b0f
  - [design_concern] src/cowabunga_api/routers/openai/completions.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (42 LOC): zero importers, not an entry point
    fingerprint: 561d5844044ecdca
  - [design_concern] src/cowabunga_api/routers/openai/embeddings.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (56 LOC): zero importers, not an entry point
    fingerprint: 504b31036027c5f3
  - [design_concern] src/cowabunga_api/routers/openai/files.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (161 LOC): zero importers, not an entry point
    fingerprint: e1d9fb7bbf57844b
  - [design_concern] src/cowabunga_api/routers/openai/models.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (25 LOC): zero importers, not an entry point
    fingerprint: cfdccfd441eda2e3
  - [design_concern] src/cowabunga_api/routers/openai/threads.py
    summary: Design signals from orphaned, signature
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, signature
    evidence: [orphaned] Orphaned file (109 LOC): zero importers, not an entry point
    fingerprint: 81ded9040425acb3
  - [design_concern] src/cowabunga_api/typedef/audio/audio_types.py
    summary: Design signals from smells
    question: Review the flagged patterns — are they design problems that need addressing, or acceptable given the file's role?
    evidence: Flagged by: smells
    evidence: [smells] 2x Loose type annotation — use specific types
    fingerprint: 8cc71a831c2e1235
  - [design_concern] src/cowabunga_api/utils/database_factory.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (66 LOC): zero importers, not an entry point
    fingerprint: 0cc231bfb67dd8d2
  - [design_concern] src/cowabunga_api/utils/logging_tools.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (12 LOC): zero importers, not an entry point
    fingerprint: f73d61dcb5c3fdf7
  - [design_concern] src/cowabunga_evals/evals/human_eval.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (50 LOC): zero importers, not an entry point
    fingerprint: a34f5ede3c38e02c
  - [design_concern] src/cowabunga_evals/evals/mmlu.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (28 LOC): zero importers, not an entry point
    fingerprint: f03121a496df07b1
  - [design_concern] src/cowabunga_evals/evals/niah_eval.py
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (55 LOC): zero importers, not an entry point
    fingerprint: 4e5eb883f7eeb56d
  (+17 more — use `desloppify show <detector> --no-budget` to explore)
...
then read the actual source code.
  ...
  desloppify show boilerplate_duplication --no-budget      # 6 findings
  desloppify show orphaned --no-budget      # 44 findings
  desloppify show signature --no-budget      # 12 findings
  desloppify show smells --no-budget      # 86 findings
